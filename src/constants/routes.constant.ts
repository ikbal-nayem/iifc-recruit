...
export const ROUTES = {
	...
	JOB_REQUEST_MANAGE: (id?: string) => `/admin/job-management/request/manage/${id}`,
	...
	MANAGE_PENDING_APPLICATION: (id?: string) => `/admin/application/pending/${id}/manage`,
	MANAGE_PROCESSING_APPLICATION: (id?: string) => `/admin/application/processing/${id}/manage`,
	APPLICATION_MANAGE: (id?: string) => `/admin/application/pending/${id}/manage`,
