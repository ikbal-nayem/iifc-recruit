...
const GenerateJobDescriptionInputSchema = z.object({
  jobTitle: z.string().describe('The title of the job to generate a description for.'),
  keywords: z
    .string()
    .describe(
      'A comma separated list of keywords that should be included in the job description.'
    ),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert HR assistant specializing in writing job descriptions based on the job title and keywords provided.

  You will use this information to write a job description.
