      ...
      <section className="container mx-auto px-4 md:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card key={index} className="flex flex-col group glassmorphism hover:border-primary transition-all">
               <CardHeader>
                <div className="relative h-48 w-full overflow-hidden rounded-lg">
                 ...
                 <CardTitle className="font-headline text-xl pt-4 group-hover:text-primary">{project.title}</CardTitle>
              </CardHeader>
