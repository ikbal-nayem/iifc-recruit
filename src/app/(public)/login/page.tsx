    ...
    <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div className="hidden lg:flex flex-col items-center justify-center p-12 bg-muted/50 relative overflow-hidden">
         ...
         <div className="relative z-10 text-center">
            ...
            <h1 className="text-4xl font-headline font-bold text-white shadow-lg">
                Your Gateway to Opportunity
            </h1>
            <p className="mt-4 text-lg text-white/90 shadow-lg">
                Join a network of professionals and leading companies.
            </p>
        </div>
      </div>
