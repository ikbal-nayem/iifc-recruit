...
const servicesTranslations = {
	...
	bn: {
		...
		description2:
			'একটি সরকারি-মালিকানাধীন পরামর্শ সংস্থা হিসাবে, আমাদের প্রাথমিক উদ্দেশ্য হল জনসাধারণ এবং বেসরকারি খাতের উভয়ের জন্য বিশেষজ্ঞ, স্বাধীন পরামর্শ প্রদান করে অবকাঠামোতে বেসরকারি বিনিয়োগ ত্বরান্বিত করা।',
